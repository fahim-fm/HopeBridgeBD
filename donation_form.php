...
if (isset($_GET['id'])) {
  ...
  $stmt = mysqli_prepare(
    $conn,
    "SELECT * FROM donations WHERE id = ? AND donor_id = ? LIMIT 1"
  );
...
<head>
  ...
  <title><?php echo $edit ? 'Edit' : 'Add'; ?> Donation — HopeBridgeBD</title>
      ...
      <div class="col-11 col-md-8 col-lg-7">
        <div class="form-card">
          ...
          <div class="d-flex align-items-center gap-2 mb-4">
            <a href="donor_dashboard.php" class="text-muted text-decoration-none">
          ...
          <form method="post" action="donation_save.php" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label class="form-label" for="title">Donation Title <span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
              <label class="form-label" for="image">
                Donation Image <?php echo $edit ? '' : '<span class="text-danger">*</span>'; ?>
              </label>
            ...
            <div class="d-flex flex-wrap gap-2 mt-4">
              ...
              <a href="donor_dashboard.php" class="btn btn-outline-secondary px-4">Cancel</a>
            </div>
          </form>
